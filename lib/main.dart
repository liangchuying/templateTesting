...
void main() {
  runApp(MaterialApp(debugShowCheckedModeBanner: false, home: MyCalculator()));
...
class _MyCalculatorState extends State<MyCalculator> {
                ...
                children: <Widget>[
                  neuButton(
                      ...
                      borderRadius: BorderRadius.only(
                        topLeft: Radius.circular(w1),
                        topRight: Radius.circular(w1 / 2),
                        bottomLeft: Radius.circular(w1 / 2),
                        bottomRight: Radius.circular(w1 / 2),
                      )),
                  neuButton(
                    label: "÷",
                    colorText: opColor,
                  ...
                  neuButton(
                      ...
                      colorText: opColor,
                      borderRadius: BorderRadius.only(
                        topLeft: Radius.circular(w1 / 2),
                        topRight: Radius.circular(w1),
                        bottomLeft: Radius.circular(w1 / 2),
                        bottomRight: Radius.circular(w1 / 2),
                      )),
                  neuButton(
                  ...
                  neuButton(
                      ...
                      borderRadius: BorderRadius.only(
                        ...
                        topRight: Radius.circular(w1 / 2),
                        bottomLeft: Radius.circular(w1 / 2),
                        bottomRight: Radius.circular(w1),
                      )),
                ],
              ),
            ),
  ...
  neuButton(
      {label, colorText, colorBack = bgColor, BorderRadius? borderRadius}) {
    return Padding(
        ...
        child: Container(
            ...
            child: NeuButton(
              borderRadius:
                  borderRadius ?? BorderRadius.all(Radius.circular(w1 / 2)),
              color: colorBack,
              onPressed: () {
                switch (label) {
                  case 'AC':
